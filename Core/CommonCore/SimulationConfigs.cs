...
namespace Common.Core
{
    ...
    #region PV Simulation Configs (unchanged)
    ...
    public class GroundSurfaceConfig
    {
        ...
        /// <summary>Obstacle meshes converted from input Breps for SVF and solar exposure calculation.</summary>
        public List<Rhino.Geometry.Mesh> ObstacleMeshes { get; set; } = new List<Rhino.Geometry.Mesh>();

        /// <summary>Number of analysis points.</summary>
        public int PointCount => AnalysisPoints?.Count ?? 0;

        /// <summary>Number of obstacles.</summary>
        public int ObstacleCount => ObstacleMeshes?.Count ?? 0;
    }
